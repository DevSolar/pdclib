...
#pragma GCC diagnostic ignored "-Wformat"
    ...
    */
    ...
    /* Decimal -- Double */
    PRINTF_TEST( 21, "-1230000000000.000000", "%f", -123e10 );
    PRINTF_TEST( 16, "-12300000.000000", "%f", -12300000.0 );
    PRINTF_TEST( 12, "-1230.000000", "%f", -1230.0 );
    PRINTF_TEST( 11, "-123.000000", "%f", -123.0 );
    PRINTF_TEST( 10, "-12.300000", "%f", -12.3 );
    PRINTF_TEST(  9, "-1.230000", "%f", -1.23 );
    PRINTF_TEST(  9, "-0.123000", "%f", -0.123 );
    PRINTF_TEST(  9, "-0.012300", "%f", -0.0123 );
    PRINTF_TEST(  9, "-0.001230", "%f", -0.00123 );
    PRINTF_TEST(  9, "-0.000123", "%f", -0.000123 );
    PRINTF_TEST(  9, "-0.000012", "%f", -0.0000123 );
    PRINTF_TEST(  9, "-0.000001", "%f", -0.00000123 );
    PRINTF_TEST(  9, "-0.000000", "%f", -123e-10 );

    PRINTF_TEST( 18, "-1230000000000.000", "%.3f", -123e10 );
    PRINTF_TEST( 13, "-12300000.000", "%.3f", -12300000.0 );
    PRINTF_TEST(  9, "-1230.000", "%.3f", -1230.0 );
    PRINTF_TEST(  8, "-123.000", "%.3f", -123.0 );
    PRINTF_TEST(  7, "-12.300", "%.3f", -12.3 );
    PRINTF_TEST(  6, "-1.230", "%.3f", -1.23 );
    PRINTF_TEST(  6, "-0.123", "%.3f", -0.123 );
    PRINTF_TEST(  6, "-0.012", "%.3f", -0.0123 );
    PRINTF_TEST(  6, "-0.001", "%.3f", -0.00123 );
    PRINTF_TEST(  6, "-0.000", "%.3f", -0.000123 );

    PRINTF_TEST( 14, "-1230000000000", "%.0f", -123e10 );
    PRINTF_TEST(  9, "-12300000", "%.0f", -12300000.0 );
    PRINTF_TEST(  5, "-1230", "%.0f", -1230.0 );
    PRINTF_TEST(  4, "-123", "%.0f", -123.0 );
    PRINTF_TEST(  3, "-12", "%.0f", -12.3 );
    PRINTF_TEST(  2, "-1", "%.0f", -1.23 );
    PRINTF_TEST(  2, "-0", "%.0f", -0.123 );

    PRINTF_TEST( 13, "-12300000.000", "%12.3f", -12300000.0 );
    PRINTF_TEST( 12, "   -1230.000", "%12.3f", -1230.0 );
    PRINTF_TEST( 12, "    -123.000", "%12.3f", -123.0 );
    PRINTF_TEST( 12, "     -12.300", "%12.3f", -12.3 );
    PRINTF_TEST( 12, "      -1.230", "%12.3f", -1.23 );
    ...
    PRINTF_TEST( 13, "-12300000.000", "%012.3f", -12300000.0 );
    PRINTF_TEST( 12, "-0001230.000", "%012.3f", -1230.0 );
    PRINTF_TEST( 12, "-0000123.000", "%012.3f", -123.0 );
    PRINTF_TEST( 12, "-0000012.300", "%012.3f", -12.3 );
    PRINTF_TEST( 12, "-0000001.230", "%012.3f", -1.23 );
    PRINTF_TEST( 12, "-0000000.123", "%012.3f", -0.123 );
    PRINTF_TEST( 12, "-0000000.012", "%012.3f", -0.0123 );
    PRINTF_TEST( 12, "-0000000.001", "%012.3f", -0.00123 );
    PRINTF_TEST( 12, "-0000000.000", "%012.3f", -0.000123 );
    ...
    /* Exponent -- Double */
    PRINTF_TEST( 13, "-1.230000e+12", "%e", -123e10 );
    PRINTF_TEST( 13, "-1.230000e+07", "%e", -12300000.0 );
    PRINTF_TEST( 13, "-1.230000e+03", "%e", -1230.0 );
    PRINTF_TEST( 13, "-1.230000e+02", "%e", -123.0 );
    PRINTF_TEST( 13, "-1.230000e+01", "%e", -12.3 );
    PRINTF_TEST( 13, "-1.230000e+00", "%e", -1.23 );
    PRINTF_TEST( 13, "-1.230000e-01", "%e", -0.123 );
    PRINTF_TEST( 13, "-1.230000e-02", "%e", -0.0123 );
    PRINTF_TEST( 13, "-1.230000e-03", "%e", -0.00123 );
    PRINTF_TEST( 13, "-1.230000e-04", "%e", -0.000123 );
    PRINTF_TEST( 13, "-1.230000e-05", "%e", -0.0000123 );
    PRINTF_TEST( 13, "-1.230000e-06", "%e", -0.00000123 );
    PRINTF_TEST( 13, "-1.230000e-08", "%e", -123e-10 );

    PRINTF_TEST( 10, "-1.230e+12", "%.3e", -123e10 );
    PRINTF_TEST( 10, "-1.230e+07", "%.3e", -12300000.0 );
    PRINTF_TEST( 10, "-1.230e+03", "%.3e", -1230.0 );
    PRINTF_TEST( 10, "-1.230e+02", "%.3e", -123.0 );
    PRINTF_TEST( 10, "-1.230e+01", "%.3e", -12.3 );
    PRINTF_TEST( 10, "-1.230e+00", "%.3e", -1.23 );
    PRINTF_TEST( 10, "-1.230e-01", "%.3e", -0.123 );
    PRINTF_TEST( 10, "-1.230e-02", "%.3e", -0.0123 );
    PRINTF_TEST( 10, "-1.230e-03", "%.3e", -0.00123 );
    PRINTF_TEST( 10, "-1.230e-04", "%.3e", -0.000123 );
    PRINTF_TEST( 10, "-1.230e-05", "%.3e", -0.0000123 );
    PRINTF_TEST( 10, "-1.230e-06", "%.3e", -0.00000123 );
    PRINTF_TEST( 10, "-1.230e-08", "%.3e", -123e-10 );

    PRINTF_TEST(  6, "-1e+12", "%.0e", -123e10 );
    PRINTF_TEST(  6, "-1e+07", "%.0e", -12300000.0 );
    PRINTF_TEST(  6, "-1e+03", "%.0e", -1230.0 );
    PRINTF_TEST(  6, "-1e+02", "%.0e", -123.0 );
    PRINTF_TEST(  6, "-1e+01", "%.0e", -12.3 );
    PRINTF_TEST(  6, "-1e+00", "%.0e", -1.23 );
    PRINTF_TEST(  6, "-1e-01", "%.0e", -0.123 );
    PRINTF_TEST(  6, "-1e-02", "%.0e", -0.0123 );
    PRINTF_TEST(  6, "-1e-03", "%.0e", -0.00123 );
    PRINTF_TEST(  6, "-1e-04", "%.0e", -0.000123 );
    PRINTF_TEST(  6, "-1e-05", "%.0e", -0.0000123 );
    PRINTF_TEST(  6, "-1e-06", "%.0e", -0.00000123 );
    PRINTF_TEST(  6, "-1e-08", "%.0e", -123e-10 );
    ...
    PRINTF_TEST( 12, "-001.230e+07", "%012.3e", -12300000.0 );
    PRINTF_TEST( 12, "-001.230e+03", "%012.3e", -1230.0 );
    PRINTF_TEST( 12, "-001.230e+02", "%012.3e", -123.0 );
    PRINTF_TEST( 12, "-001.230e+01", "%012.3e", -12.3 );
    PRINTF_TEST( 12, "-001.230e+00", "%012.3e", -1.23 );
    PRINTF_TEST( 12, "-001.230e-01", "%012.3e", -0.123 );
    PRINTF_TEST( 12, "-001.230e-02", "%012.3e", -0.0123 );
    PRINTF_TEST( 12, "-001.230e-03", "%012.3e", -0.00123 );
    PRINTF_TEST( 12, "-001.230e-04", "%012.3e", -0.000123 );
    PRINTF_TEST( 12, "-001.230e-05", "%012.3e", -0.0000123 );
    PRINTF_TEST( 12, "-001.230e-06", "%012.3e", -0.00000123 );
    PRINTF_TEST( 12, "-001.230e-08", "%012.3e", -123e-10 );
    ...
    /* Generic -- Double */
    PRINTF_TEST(  9, "-1.23e+12", "%g", -123e10 );
    PRINTF_TEST(  9, "-1.23e+07", "%g", -12300000.0 );
    PRINTF_TEST(  5, "-1230",     "%g", -1230.0 );
    PRINTF_TEST(  4, "-123",      "%g", -123.0 );
    PRINTF_TEST(  5, "-12.3",     "%g", -12.3 );
    PRINTF_TEST(  5, "-1.23",     "%g", -1.23 );
    PRINTF_TEST(  6, "-0.123",    "%g", -0.123 );
    PRINTF_TEST(  7, "-0.0123",   "%g", -0.0123 );
    PRINTF_TEST(  8, "-0.00123",  "%g", -0.00123 );
    PRINTF_TEST(  9, "-0.000123", "%g", -0.000123 );
    PRINTF_TEST(  9, "-1.23e-05", "%g", -0.0000123 );
    PRINTF_TEST(  9, "-1.23e-06", "%g", -0.00000123 );
    PRINTF_TEST(  9, "-1.23e-08", "%g", -123e-10 );

    PRINTF_TEST(  9, "-1.23e+12", "%.3g", -123e10 );
    PRINTF_TEST(  9, "-1.23e+07", "%.3g", -12300000.0 );
    PRINTF_TEST(  9, "-1.23e+03", "%.3g", -1230.0 );
    PRINTF_TEST(  4, "-123",      "%.3g", -123.0 );
    PRINTF_TEST(  5, "-12.3",     "%.3g", -12.3 );
    PRINTF_TEST(  5, "-1.23",     "%.3g", -1.23 );
    PRINTF_TEST(  6, "-0.123",    "%.3g", -0.123 );
    PRINTF_TEST(  7, "-0.0123",   "%.3g", -0.0123 );
    PRINTF_TEST(  8, "-0.00123",  "%.3g", -0.00123 );
    PRINTF_TEST(  9, "-0.000123", "%.3g", -0.000123 );
    PRINTF_TEST(  9, "-1.23e-05", "%.3g", -0.0000123 );
    PRINTF_TEST(  9, "-1.23e-06", "%.3g", -0.00000123 );
    PRINTF_TEST(  9, "-1.23e-08", "%.3g", -123e-10 );

    PRINTF_TEST(  6, "-1e+12",  "%.0g", -123e10 );
    PRINTF_TEST(  6, "-1e+07",  "%.0g", -12300000.0 );
    PRINTF_TEST(  6, "-1e+03",  "%.0g", -1230.0 );
    PRINTF_TEST(  6, "-1e+02",  "%.0g", -123.0 );
    PRINTF_TEST(  6, "-1e+01",  "%.0g", -12.3 );
    PRINTF_TEST(  2, "-1",      "%.0g", -1.23 );
    PRINTF_TEST(  4, "-0.1",    "%.0g", -0.123 );
    PRINTF_TEST(  5, "-0.01",   "%.0g", -0.0123 );
    PRINTF_TEST(  6, "-0.001",  "%.0g", -0.00123 );
    PRINTF_TEST(  7, "-0.0001", "%.0g", -0.000123 );
    PRINTF_TEST(  6, "-1e-05",  "%.0g", -0.0000123 );
    PRINTF_TEST(  6, "-1e-06",  "%.0g", -0.00000123 );
    PRINTF_TEST(  6, "-1e-08",  "%.0g", -123e-10 );
    ...
    PRINTF_TEST( 12, "-0001.23e+07", "%012.3g", -12300000.0 );
    PRINTF_TEST( 12, "-0001.23e+03", "%012.3g", -1230.0 );
    PRINTF_TEST( 12, "-00000000123", "%012.3g", -123.0 );
    PRINTF_TEST( 12, "-000000012.3", "%012.3g", -12.3 );
    PRINTF_TEST( 12, "-00000001.23", "%012.3g", -1.23 );
    PRINTF_TEST( 12, "-0000000.123", "%012.3g", -0.123 );
    PRINTF_TEST( 12, "-000000.0123", "%012.3g", -0.0123 );
    PRINTF_TEST( 12, "-00000.00123", "%012.3g", -0.00123 );
    PRINTF_TEST( 12, "-0000.000123", "%012.3g", -0.000123 );
    PRINTF_TEST( 12, "-0001.23e-05", "%012.3g", -0.0000123 );
    PRINTF_TEST( 12, "-0001.23e-06", "%012.3g", -0.00000123 );
    PRINTF_TEST( 12, "-0001.23e-08", "%012.3g", -123e-10 );
