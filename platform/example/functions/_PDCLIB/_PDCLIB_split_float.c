/* _PDCLIB_split_float( float, unsigned *, _PDCLIB_bigint_t * )
...
int _PDCLIB_split_float( float value, unsigned * exponent, _PDCLIB_bigint_t * significand )
{
    union
    {
        float value;
